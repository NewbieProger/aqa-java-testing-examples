...
public class TestExample {
    ...
    /**
     * Here's you can see an example of using one of the methods for waiting<br>
     * We check that DB has been cleared and if not we wait for it<br>
     * At the 20th row you can see that we attach something if the retires count exhausted
     */
    @Test
